...
<html lang="en">
<head>
<title>Watch Dog : Financial Folder</title>
	...
	<div class="container">
		...
		<div class="row" style="padding-left: 5px;">
		   <nav aria-label="breadcrumb" style="width: 100%">
				<ol class="breadcrumb">
					    <li><a href="inputdirfin"> <i class="fa fa-folder-open" aria-hidden="true"></i> Financial</a></li>
					...
					<tbody>
						<c:forEach items="${fileList}" var="dt">
							<tr>
								...
								<td>${dt.fileStatus}</td>
								<td>
								<a href="downloadfile/${dt.fileName}/fin"  title="Download File.">
	...
	function deleteFile(val) {	
		...
		$('<div></div>').appendTo('body').html(
			...
			buttons : {
				Yes : function() {
					$(this).dialog("close");
					window.location.href = "deletefilefrominput/fin/" + val;
				},
				No : function() {
					$(this).dialog("close");
				}
